...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "trainingmanager/test/integration/FirstJourney",
    "trainingmanager/test/integration/EnrollmentsListJourney",
    "trainingmanager/test/integration/EnrollmentsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
